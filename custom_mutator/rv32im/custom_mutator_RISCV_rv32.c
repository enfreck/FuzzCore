#include "custom_mutator_RISCV_rv32.h"
...
//Supports same instructions as biriscv
    ...
    switch (opcode)
    {
        ...
        case I_TYPE_ENV:
            ...
            // change csr command 
                ...
                modified_inst.itype_inst.imm = mutate_imm(); //changed from csr to match biriscv
            }
            break;
    ...
    switch (instruction.base_inst.opcode)
    {
        ...
        case I_TYPE_ENV:
            ...
            if (instruction.itype_inst.func3 == 0) {
                ...
                instruction.itype_inst.rd = mutate_register();
                instruction.itype_inst.rs1 = mutate_register();
                instruction.itype_inst.imm = mutate_imm(); //changed from csr to match biriscv
            }
            break;
        case B_TYPE:
        //beq (func3 = 0), bne (func3 = 1), blt (func3 = 4), bge (func3 = 5), bltu (func3 = 6), bgeu (func3 = 7)
