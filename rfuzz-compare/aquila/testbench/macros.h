...
#define N_FUZZ_INPUTS 103 //finding the vector definition of fuzz_in in the .sv file 
#define N_COV_POINTS 310 // N_COV_POINTS is the same but for auto_cover_out   
#define N_ASSERTS 0
